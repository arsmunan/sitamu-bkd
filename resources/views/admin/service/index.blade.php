                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Layanan di Badan Kepegawaian Daerah</h3>
                            <div class="card-tools">
                                <a href="{{route('layanan.create')}}"><i class="fas fa-plus-square"></i> Tambah Data</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$service->fields->nama}}</td>

                                    <td class="text-center">
                                        <form action="{{ route('layanan.destroy',$service->id) }}" method="POST">
                                            <a class="btn btn-primary btn-sm" href="{{ route('layanan.edit',$service->id) }}"><i class="fas fa-edit"></i></a>
                                            @csrf
                                            @method('DELETE')
