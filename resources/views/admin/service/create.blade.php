                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('layanan.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select" id="field_id" name="field_id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="jenis_layanan" type="text" class="form-control @error('jenis_layanan') is-invalid @enderror" name="jenis_layanan" value="{{ old('jenis_layanan') }}" required autocomplete="jenis_layanan" autofocus>
